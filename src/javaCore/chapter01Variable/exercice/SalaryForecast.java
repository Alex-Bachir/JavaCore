...
public class SalaryForecast {
    ...
    // ici on calcule jusqu'a trouvé l'année brute
    public static double calculateAnnualSalary(double horaireBrut) {
    ...
    // ici on applique la cotisation
    public static double applySocialCharges(double anneBrut, double cotisation) {
        return anneBrut * (1 - cotisation);
    }
}
